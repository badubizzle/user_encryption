defmodule UserEncryptionWeb.UserControllerTest do
  use UserEncryptionWeb.ConnCase

  alias UserEncryption.Account
  alias UserEncryption.Account.User

  @create_attrs %{email: "some email", key_hash: "some key_hash", name: "some name", password_hash: "some password_hash"}
